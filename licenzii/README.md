...
* [**Запуск через Sherpa Assistant**](aktivaciya-licenzii-cherez-sherpa-assistant.md): Пользователь запускает Робота из списка доступных Роботов, что упрощает поиск нужного файла.
...
* [Sherpa Orchestrator](upravlenie-licenziyami-sherpa-rpa-cherez-sherpa-orchestrator.md)

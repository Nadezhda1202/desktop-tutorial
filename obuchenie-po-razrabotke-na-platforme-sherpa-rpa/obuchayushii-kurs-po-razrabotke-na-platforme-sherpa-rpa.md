...
> **Программа обучения** состоит из набора видео уроков, тестовых заданий и взаимодействия с куратором по электронной почте [academy@sherpa.ru](mailto:academy@sherpa.ru).
>
...
4. Выполнить тестовые практические задания и отправить их куратору на почту academy@sherpa.ru;
...
6. По итогам успешно выполненных последних заданий, обучающийсся получает сертификат о прохождении базового курса.
...
Для запроса Лицензии напишите на почту [academy@sherpa.ru](mailto:academy@sherpa.ru). Обязательно укажите:

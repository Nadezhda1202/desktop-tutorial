...
**Работа в консоли продемонстрирована в следующем видео:**

{% embed url="https://sherparpa.ru/ucontent/?02" %}

**Как использовать подсказки IntelliSense в консоли Sherpa Designer подемонстрировано в следующем видео:**

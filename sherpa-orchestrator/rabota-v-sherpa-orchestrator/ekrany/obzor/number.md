...
Виджет Number отображает числа, что позволяет Пользователям легко воспринимать и анализировать данные.&#x20;

<figure><img src="https://lh7-rt.googleusercontent.com/docsz/AD_4nXf_hsieQfUXlduvtA0fhIsZ6_PvuLmIDF_Z3F7AV8hTxqbc9IC-JRSFkUPvsb69IkwHVxLcYnus1rFW8SOdcZv50QbWMexZ2fx-IKvC04Ouiz7FOSDhUhcdIKxGdL1bLFrNYWIrng?key=ArGsMFxOZt6u_AfXAA-94iWG" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../../.gitbook/assets/Number.png" alt=""><figcaption></figcaption></figure>

Откроется всплывающее окно “Настройки виджета”:

<figure><img src="../../../../.gitbook/assets/изображение (12) (1) (1).png" alt=""><figcaption></figcaption></figure>
...
| **Название**                                        | **Описание**                                                                                                                                                                                                                                                                                       |
| --------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Режим конструктора](number.md#rezhim-konstruktora) | Позволяет собрать запрос из отдельных блоков. В каждом блоке (Объединение таблиц, Фильтры, Ряды виджета, Группировка по, Сортировка, Количество строк) есть возможность настроить нужные команды для работы с данными, арифметические и логические команды, операторы сравнения.                   |
| [Расширенный режим](number.md#rasshirennyi-rezhim)  | <p>Позволяет ввести запрос вручную в поле SQL:</p><p><img src="https://lh7-rt.googleusercontent.com/docsz/AD_4nXcd7OIaI1R6U2xJuYuo33WaYxtzln9tYAyEjwgkaFQvmWk9805MgjR88D_8QBjGAHjvMQvGc2LJSshFRdlLNMIMSC0Bnxvufy0eEUv9QIz2KAfRGIeFykHpvaX7g_W6kqH1KqmPQg?key=nCUpXC2iKtVeq12Xi8RnWuyw" alt=""></p> |
...
Для вывода количества Работ на Дашборд Number, необходимо внести в соответствующие поля в окне "Настройки виджета" данные:

## Режим конструктора (пример)

<figure><img src="https://lh7-rt.googleusercontent.com/docsz/AD_4nXdjSgusgIGVIZk8URZ7ZNe59Oytp46rLj3VI2Zp5QkKZ7gBTwqSnYmVzqY7WhwFyAjBnnCcAvM8spLpUNLOocTYWA6pJ4qeH50S__oQdVjerxp73c8yvlJQFZHWfUOlruJcgZrpsA?key=ArGsMFxOZt6u_AfXAA-94iWG" alt=""><figcaption></figcaption></figure>

<figure><img src="https://lh7-rt.googleusercontent.com/docsz/AD_4nXf1qM5LLWmlWA84_9m_RgXCJ4vfc3E_eyr4QH-QVyjTchXvozTUvCHfmVVyrS20VEbA29JAE9IsAoMwUJzGr2lCjedGQi6-pppWQ5c56jCPCpV7_E1wcYe623japDxKixtRzDIRLw?key=ArGsMFxOZt6u_AfXAA-94iWG" alt=""><figcaption></figcaption></figure>
